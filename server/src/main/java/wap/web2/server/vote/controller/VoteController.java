...
public class VoteController {
    ...
    @Operation(
        summary = "투표 참여 프로젝트 목록 조회",
        description = "특정 학기 투표에 참여하는 프로젝트 목록을 조회합니다."
    )
    ...
    @GetMapping("/now")
    @Operation(
        summary = "현재 학기 투표 상태 조회",
        description = "현재 학기 투표 여부와 투표 진행 상태를 조회합니다."
    )
    ...
    @Operation(
        summary = "최신 투표 결과 조회",
        description = "가장 최신 공개 투표 결과를 조회합니다."
    )
    ...
    @Operation(
        summary = "학기별 투표 결과 조회",
        description = "특정 학기의 투표 결과를 조회합니다."
    )
